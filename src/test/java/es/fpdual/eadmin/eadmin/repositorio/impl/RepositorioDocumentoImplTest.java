...
public class RepositorioDocumentoImplTest {
	...
	private final Documento documento =
			...
			new Documento(CODIGO_DOCUMENTO, NOMBRE_DOCUMENTO, FECHA_CREACION, FECHA_ULTIMA_MODIFICACION,
	...
	public void deberiaModificarUnDocumento() {
		...
		final Documento documento2 = new Documento(CODIGO_DOCUMENTO, NOMBRE_DOCUMENTO, FECHA_CREACION,
